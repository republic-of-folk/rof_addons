...
force force ace_nightvision_effectScaling = 0.52622;
force force ace_nightvision_fogScaling = 0.52622;
...
force acex_field_rations_timeWithoutFood = 0.1;
force acex_field_rations_timeWithoutWater = 0.1;
...
force force L_Suppress_halting = false;
force force L_Suppress_intensity = 0;
