...
class CfgPatches
{
    class rof_patch_soviet_armed_forces
    {
        ...
        weapons[] = {};
        requiredVersion = 1.5;
        requiredAddons[] = {"A3_Characters_F", "rhs_main", "40th_bp_cfg", "oksv_units_addon", "40th_headgears_cfg", "40th_insignia_cfg", "40th_objects_cfg", "40th_vests_cfg", "40th_weapons_cfg"};
    };
};
