...
class car : baseMan
{
    ...
    primaryWeapon[] = {"arifle_MSBS65_camo_F"};
    scope[] = {"optic_Arco_lush_F"};
    silencer[] = {"suppressor_65_black_RF"};
...
class r : car
{
    ...
    primaryWeapon[] = {"arifle_MSBS65_UBS_camo_F"};
    magazines[] +=
    {
...
class smg : car
{
    displayName = "Rifleman (Vektor)";
    primaryWeapon[] = {"arifle_VelkoR5_lxWS"};
    silencer[] = {"suppressor_l_lxWS"};
    attachment[] = {"acc_pointer_IR"};
    scope[] = {"optic_r1_high_lxWS"};
    magazines[] =
    {
        LIST_6("35Rnd_556x45_Velko_reload_tracer_red_lxWS"),
        LIST_2("SmokeShell"),
        LIST_2("HandGrenade"),
        LIST_2("16Rnd_9x21_Mag")
    };
...
class g : car
{
    ...
    primaryWeapon[] = {"arifle_MSBS65_GL_camo_F"};
    magazines[] +=
    {
...
class ftl : car
{
    ...
    magazines[] +=
    {
        ...
        LIST_4("1Rnd_Smoke_Grenade_shell"),
        LIST_2("ACE_40mm_Flare_ir"),
        LIST_2("1Rnd_RC40_shell_RF")
    };
    linkedItems[] +=
    {
        "Binocular",
...
class dm : car
{
    ...
    primaryWeapon[] = {"arifle_MSBS65_Mark_camo_F"};
    scope[] = {"optic_SOS"};
