class baseMan {// Weaponless baseclass
    ...
    uniform[] =
    {
        "U_lxWS_B_CombatUniform_desert","U_lxWS_B_CombatUniform_desert",
...
class car : baseMan
{
    ...
    headgear[] = {"H_HelmetB_plain_sb_khaki_RF"};
    hmd[] = {"NVGoggles"};
    vest[] = {"V_lxWS_PlateCarrier2_desert"};
    backpack[] = {"B_AssaultPack_desert_lxWS"};

    primaryWeapon[] = {"arifle_MXC_F"};
    scope[] = {"optic_aco"};
    silencer[] = {"suppressor_65_sand_RF"};
    attachment[] = {"acc_pointer_IR_sand_lxWS"};
    
    sidearmWeapon[] = {"hgun_Glock19_auto_Tan_RF"};
    sidearmAttachments[] = {"acc_flashlight_IR_pistol_RF", "optic_MRD"};
    ...
    magazines[] =
    {
        ...
        LIST_1("33Rnd_9x19_Yellow_Mag_Tan_RF")
    };
...
class g : car
{
    ...
    vest[] = {"V_lxWS_PlateCarrierGL_desert"};
    magazines[] +=
    {
...
class m : car
{
    displayName = "Medic";
    traits[] += {"medic"};
    vest[] = {"V_lxWS_PlateCarrierSpec_desert"};
...
class dm : r
{
    ...
    primaryWeapon[] = {"srifle_h6_tan_rf"};
...
class matg : car
{
    ...
    secondaryAttachments[] = {"acc_pointer_IR_sand_lxWS"};
    backpack[] = {"B_Kitbag_desert_lxWS"};
    backpackItems[] =
    {
        LIST_2("MRAWS_HEAT_F"),
...
class pp : smg
{
    ...
    uniform[] = {"U_B_HeliPilotCoveralls_MTP_RF"};
    vest[] = {"V_TacVest_khk"};
    backPack[] = {};
