...
class car : baseMan
{
    ...
    headgear[] = {"H_HelmetB_plain_sb_wdl_RF"};
    hmd[] = {"NVGoggles_OPFOR"};
    ...
    scope[] = {"optic_aco"};
    silencer[] = {"suppressor_65_green_RF"};
    attachment[] = {"acc_pointer_ir"};
    
    sidearmWeapon[] = {"hgun_Glock19_auto_RF"};
    sidearmAttachments[] = {"acc_flashlight_IR_pistol_RF", "optic_MRD_black"};
    ...
    magazines[] =
    {
        ...
        LIST_1("33Rnd_9x19_Yellow_Mag_RF")
    };
...
class dm : r
{
    ...
    primaryWeapon[] = {"srifle_h6_oli_rf"};
